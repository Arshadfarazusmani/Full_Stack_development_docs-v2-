...
A Single Page Application (SPA) is a type of web application where the entire website loads once, and after that only the required content changes, without reloading the whole page.

👉 In simple words:
The page does not refresh again and again—only the data on the page updates.
